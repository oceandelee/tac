...
#%%
pprint(model.wv.most_similar("inondations", topn=3))

#%%
pprint(model.wv.most_similar("crue"))

#%%
pprint(model.wv.most_similar(positive=['inondations', 'crue'], negative=['sinistre']))
